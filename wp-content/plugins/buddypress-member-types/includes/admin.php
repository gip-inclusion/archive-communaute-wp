...
class BuddyBoss_BMT_Admin {
	...
	public function setup() {
		...
		if ( $this->network_activated && ! defined('BP_ENABLE_MULTIBLOG') ) {
	...
	*/
	...
	public function setting_hide_member_type_field() {
		...
		echo "<input ".$checked." id='enabled_hide_from_registration' name='buddyboss_bmt_plugin_options[hide_member_type_field]' type='checkbox' value='true' />  ";
	...
	public function setting_registration_required_field() {
		...
		echo "<input ".$checked." id='enabled_require_on_registration' name='buddyboss_bmt_plugin_options[registration_required_field]' type='checkbox' value='true' />  ";
	...
	public function setting_default_member_type() {
		...
		echo '<select id="enabled_default_member_type" name="buddyboss_bmt_plugin_options[default_member_type]">';
