...
if ( ! class_exists( 'BP_Notifications_Background_Updater' ) ) {
	...
	/**
	 * BP_Notifications_Background_Updater Class.
	 */
	class BP_Notifications_Background_Updater extends BP_Background_Process {
		...
		public function __construct() {
			...
			$this->action = 'bb_notifications_updater';
		...
		public function dispatch() {
			...
			if ( is_wp_error( $dispatched ) ) {
				error_log( sprintf( 'Unable to dispatch BuddyBoss Notifications updater: %s', $dispatched->get_error_message() ) );
			}
		}
