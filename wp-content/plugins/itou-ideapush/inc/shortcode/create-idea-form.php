...
function idea_push_form_render_output($boardNumber){
    ...
    //lets get the users info if they exist
        ...
        $html .= '<textarea class="ideapush-form-idea-description" placeholder="'.__($ideaDescriptionPlaceholder,'ideapush').'" maxlength="2000" rows="8" required="required"></textarea>';
