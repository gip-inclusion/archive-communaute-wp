...
/* ajaxMacros.twig */
class __TwigTemplate_777fc9ed37752b63782657dd58a701dc073bf528e9b93e4dbddcbd3e44cd57cd extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    // line 16
    public function macro_requestErrorDiv($__emailSuperUser__ = null, $__areAdsForProfessionalServicesEnabled__ = false, $__currentModule__ = "", $__showMoreHelp__ = false, ...$__varargs__)
    {
        $macros = $this->macros;
        $context = $this->env->mergeGlobals([
...
{% endmacro %}
", "ajaxMacros.twig", "/Users/deloo/Prestas/Beta.gouv/itou-communaute/wp-content/plugins/matomo/app/plugins/Morpheus/templates/ajaxMacros.twig");
    }
}
