...
class __TwigTemplate_79a1edae1fcc0413843f92c855e8edd20c653e39f1e2c2243a285f83bbe4c45a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            // line 5
            if ((twig_get_attribute($this->env, $this->source, (isset($context["evolution"]) || array_key_exists("evolution", $context) ? $context["evolution"] : (function () { throw new RuntimeError('Variable "evolution" does not exist.', 5, $this->source); })()), "percent", [], "any", false, false, false, 5) < 0)) {
                // line 6
                echo "        ";
                ...
                // line 8
                echo "    ";
            } elseif (((twig_get_attribute($this->env, $this->source, (isset($context["evolution"]) || array_key_exists("evolution", $context) ? $context["evolution"] : (function () { throw new RuntimeError('Variable "evolution" does not exist.', 8, $this->source); })()), "percent", [], "any", false, false, false, 8) == 0) || (twig_get_attribute($this->env, $this->source, (isset($context["evolution"]) || array_key_exists("evolution", $context) ? $context["evolution"] : (function () { throw new RuntimeError('Variable "evolution" does not exist.', 8, $this->source); })()), "percent", [], "any", false, false, false, 8) == "0%"))) {
                // line 9
                echo "        ";
...
{% endmacro %}
", "@CoreVisualizations/macros.twig", "/Users/deloo/Prestas/Beta.gouv/itou-communaute/wp-content/plugins/matomo/app/plugins/CoreVisualizations/templates/macros.twig");
    }
}
